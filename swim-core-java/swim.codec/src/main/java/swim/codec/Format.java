...
public final class Format {
    ...
    /**
     * Returns the operating system specific string used to separate lines of text.
     * <p>
     * Unit tests on this package should be aware that on Windows this will return \r\n and {@link String#equals(Object)}
     * will check if the Strings are of the same length in assertions.
     */
